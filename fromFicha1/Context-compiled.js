...
function Context() {
     ...
     */
    function setUsage() {
        usage = "Football Data HTML Generator\n\r" + "Usage: node football-data.js \<options>\n\r" + "Where options include:\n\r" + "-usage Shows the application usage\n\r" + "-file \<file-path> Reads all arguments from the text file in <file-path>\n\r" + "-leagues \<leagues-list> A comma separated list of the league names or its short" + "names (e.g Primeira Liga, 2015/2016, PD)\n\r" + "-generate [teams|fixtures|leagueTable|players] What to generate. A comma" + "separated list of the defined values.\n\r" + "-output <dir-path> Path to output directory where files are generated.";
     ...
     */
    var putArgumentInContext = function putArgumentInContext(val, index, array) {
